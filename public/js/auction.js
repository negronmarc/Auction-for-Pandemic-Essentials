...
const productId = parseInt(
  document.querySelector(".product-id").getAttribute("id")
);
const bidCount = parseInt(
  document.querySelector(".bid-count").getAttribute("data-bid-count")
);
const currentBid = parseInt(
  document.querySelector(".current-bid").getAttribute("data-current-bid")
);
